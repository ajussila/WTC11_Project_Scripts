...
### python workerADAMRAD21_CHATDNAd14.py
#################################################################
...
#W:\Adam\E217_WTC11_day14_Rad21_CHATDNA\AnalysisDeconvolve_CG
save_folder = r'W:\Adam\E217_WTC11_day14_CTCF_CHATDNA\AnalysisDeconvolve_CGBogdanV'
...
def main_f(set_ifov,try_mode=True):
    ...
    #\\132.239.162.128\Public\Adam\E201_WTC11_WTday15__10_20_2023\RNA_CG
    #Z:\Adam\E201_WTC11_WTday15__10_20_2023
    #W:\Adam\E217_WTC11_day14_Rad21_CHATDNA
    all_flds_ = glob.glob(r'W:\Adam\E217_WTC11_day14_Rad21_CHATDNA\H*B*'+set__) ################################# modify for 3-col small tad 
    redefine_color += [[0,1,2,3]]*len(all_flds_) #### three signal color
    all_flds+=all_flds_
...
##python C:\Users\cfg001\Desktop\WTC11\workerADAM_CTCF_CHATDNAd14BogdanVerified.py

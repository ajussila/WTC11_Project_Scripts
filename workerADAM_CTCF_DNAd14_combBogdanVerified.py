...
save_folder = r'W:\Adam\E218_WTC11_day14_CTCF_DNA_MERFISH\AnalysisDeconvolve_CGBogdanV'
...
def main_f(set_ifov,try_mode=True):
    ...
    #W:\Adam\E218_WTC11_day14_CTCF_DNA_MERFISH
    all_flds_ = glob.glob(r'W:\Adam\E218_WTC11_day14_CTCF_DNA_MERFISH\H*DMER*'+set__) ################################# modify for 3-col small tad 
    redefine_color += [[0,1,2,3]]*len(all_flds_) #### three signal color
    all_flds+=all_flds_
...
##python C:\Users\cfg001\Desktop\WTC11\workerADAM_CTCF_DNAd14_combBogdanVerified.py

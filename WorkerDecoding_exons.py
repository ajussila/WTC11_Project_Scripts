### RHis assumes that the fitting and the dapi feature fitting is complete

def run_single_fov_decoding(save_folder,fov,set_='',lib_fl = r'C:\Users\cfg001\Desktop\WTC11\Adam_exons_1_27_2024_withBlank.csv',redo=False):
...
from ioMicro import *
#from ioMicro import *
all_flds = glob.glob(r'W:\Adam\E211_WTC11_day14_Rad21\H*_RMER_Q*')
...
save_folder = r'W:\Adam\E211_WTC11_day14_Rad21\Analysis_Deconvolve_CG\RNA_Exons'


def fov_to_dapi_features(fov='Conv_zscan__010',save_folder_ref=r'W:\Adam\E211_WTC11_day14_Rad21\Analysis_Deconvolve_CG\RNA_Exons', save_folder=r'W:\Adam\E211_WTC11_day14_Rad21\Analysis_Deconvolve_CG\RNA_Exons',tag_new='H1_RMER_Q1',tag_ref = 'H1_DMER_1'):
    ...
    return fl,fl_ref
def load_segmentation(dec,segmentation_folder = r'W:\Adam\E211_WTC11_day14_Rad21\Analysis_Deconvolve_CG\segmentationDAPI',segm_tag='H1_DMER_1'):
    fl_segm = segmentation_folder+os.sep+dec.fov.replace('.zarr','')+'--'+segm_tag+'--CYTO_segm_expanded.npz'
...
def main_f_fov(save_folder =r'W:\Adam\E211_WTC11_day14_Rad21\Analysis_Deconvolve_CG\RNA_Exons',fov='Conv_zscan__200',set_ = '',ncols=3,
          scores_ref_fl=r'W:\Adam\E211_WTC11_day14_Rad21\Analysis_Deconvolve_CG\RNA_Exons\scoresRef.pkl',th=-1.5,force=False,segm_tag='H1_RMER_Q1',tag_new='H1_RMER_Q1'):
    ...
    if True:#not os.path.exists(fl):
        if try_mode:
            try:
                ...
                dec = main_f_fov(fov=fov,th=-1.5,force=False)
            except:
...
#conda activate cellpose2&&python D:\Carlos\NMERFISH\WorkerDecodingD111_exons.py
